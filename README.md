...
- [resumo.md](resumo.md) — Conteúdo Markdown exibido pelo botão **Consultar Resumo**.
...
- O botão **Consultar Resumo** pausa o temporizador e abre o conteúdo de `resumo.md`. Fechar o modal retoma a contagem do ponto em que ela foi pausada.
- O resumo aceita Markdown, incluindo títulos, listas, negrito e tabelas. Se o arquivo estiver vazio ou não for encontrado, o quiz exibe uma mensagem amigável.
